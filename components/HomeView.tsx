    ...
    <div className="h-full flex flex-col items-center space-y-12 animate-in fade-in zoom-in duration-1000 overflow-y-auto pt-4 pb-8">
      ...
      >
        ...
        <p className="text-sm text-[#2c3e50]/50 leading-relaxed tracking-wider font-light max-w-xl mx-auto mb-6">
          Refine the vessel for your unique journey. Attune Facilitator-AI with <strong>MAPS MDMA-AT</strong>, <strong>Integration</strong>, <strong>Sharing Circles</strong>, and safety-locked <strong>Trauma Informed</strong> + <strong>Underground Safety</strong>.
        </p>
